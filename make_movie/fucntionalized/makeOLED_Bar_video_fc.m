function makeOLED_Bar_video_fc(makemovie_folder, theta, direction, video_folder, videoworkspace_folder, type, seed_date, date, calibration_date, mins, Gvalue, mean_lumin, contrast, cutOffFreq_list)
